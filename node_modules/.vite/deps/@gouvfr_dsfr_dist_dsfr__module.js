// node_modules/@gouvfr/dsfr/dist/dsfr.module.js
var State = class {
  constructor() {
    this.modules = {};
  }
...
var startAtDomContentLoaded = (callback) => {
  if (document.readyState !== "loading") window.requestAnimationFrame(callback);
  else document.addEventListener("DOMContentLoaded", callback);
};
var startAuto = (callback) => {
...
var dispatch = (node, type, detail = null, bubbles = true, cancelable = false) => {
  const options2 = { bubbles: bubbles === true, cancelable: cancelable === true };
  if (detail) options2.detail = detail;
  const event = new CustomEvent(type, options2);
  node.dispatchEvent(event);
};
var rootDispatch = (type, detail = null, bubbles = false, cancelable = false) => dispatch(document.documentElement, type, detail, bubbles, cancelable);
var ns = (name) => `${config.prefix}-${name}`;
...
var Module = class extends Collection {
  constructor(type) {
    super();
    this.type = type;
    this.isActive = false;
...
var querySelectorAllArray = (element, selectors) => Array.prototype.slice.call(element.querySelectorAll(selectors));
var queryParentSelector = (element, selectors) => {
...
var Registration = class {
  constructor(selector2, InstanceClass, creator) {
...
var Register = class extends Module {
  constructor() {
    super("register");
  }
...
var getKeyCode = (keyCode) => Object.values(KeyCodes).filter((entry) => entry.value === keyCode)[0];
var Root = class extends Element$1 {
  constructor() {
...
var Stage = class extends Module {
  constructor() {
    super("stage");
    this.root = new Root();
    super.add(this.root);
  ...
  getElement(node) {
    for (const element2 of this.collection) if (element2.node === node) return element2;
  ...
  parse(node, registration, nonRecursive) {
    ...
    for (const registration2 of registrations) {
      const nodes = registration2.parse(node, nonRecursive);
      for (const n of nodes) {
        const element = this.getElement(n);
        element.project(registration2);
...
var Renderer = class extends Module {
  constructor() {
    super("render");
...
var Resizer = class extends Module {
  constructor() {
    super("resize");
...
var ScrollLocker = class extends Module {
  constructor() {
    super("lock");
...
var FontSwap = class extends Module {
  constructor() {
    super("font-swap");
...
var MouseMove = class extends Module {
  constructor() {
    super("mouse-move");
...
var Colors = class {
  getColor(context, use, tint, options2 = {}) {
    const option = getOption(options2);
...
var getOption = (options2) => {
  switch (true) {
    case options2.hover:
      return "-hover";
    case options2.active:
      return "-active";
    default:
      return "";
  }
...
var sanitize = (className) => className.charAt(0) === "." ? className.substr(1) : className;
...
var modifyClass = (element, className, remove) => {
...
var addClass = (element, className) => modifyClass(element, className);
var removeClass = (element, className) => modifyClass(element, className, true);
var hasClass = (element, className) => getClassNames(element).indexOf(sanitize(className)) > -1;
var ACTIONS = [
...
var Instance = class {
  ...
  register(selector2, InstanceClass) {
    const registration = state.getModule("register").register(selector2, InstanceClass, this);
  ...
  listen(type, closure, options2) {
    if (!this._listeners[type]) this._listeners[type] = [];
    const listeners = this._listeners[type];
    const listener = new Listener(this.node, type, closure, options2);
    listeners.push(listener);
    listener.listen();
  }
  unlisten(type, closure, options2) {
    if (!type) {
      for (const type2 in this._listeners) this.unlisten(type2);
      return;
    }
    const listeners = this._listeners[type];
    if (!listeners) return;
    ...
    const removal = listeners.filter((listener) => listener.closure === closure && listener.matchOptions(options2));
    removal.forEach((listener) => listener.unlisten());
    this._listeners[type] = listeners.filter((listener) => removal.indexOf(listener) === -1);
  }
  listenClick(options2) {
    this.listen("click", this._handlingClick, options2);
  }
  unlistenClick(options2) {
    this.unlisten("click", this._handlingClick, options2);
  }
  _handleClick(e) {
    this.handleClick(e);
  ...
  listenHash(hash, add) {
    ...
    this._hashes = this._hashes.filter((action2) => action2.hash !== hash);
...
var Listener = class {
  constructor(node, type, closure, options2) {
    this._node = node;
    this._type = type;
  ...
  matchOptions(options2 = null) {
    switch (true) {
      case options2 === null:
      case (typeof this._options === "boolean" && typeof options2 === "boolean" && this._options === options2):
        return true;
      case Object.keys(this._options).length !== Object.keys(options2).length:
        return false;
      case Object.keys(options2).every((key) => this._options[key] === options2[key]):
        return true;
    }
    return false;
  }
...
var Disclosure = class extends Instance {
  constructor(type, selector2, DisclosureButtonInstanceClass, disclosuresGroupInstanceClassName) {
    super();
    this.type = type;
  ...
  _spotlight() {
    this.disclose();
    this.request(() => {
      this.ascend(DisclosureEmission.SPOTLIGHT);
    });
  }
...
var DisclosureButton = class extends Instance {
  constructor(type) {
    super();
    this.type = type;
...
var DisclosuresGroup = class extends Instance {
...
var CollapseButton = class extends DisclosureButton {
  constructor() {
...
var Collapse = class extends Disclosure {
  constructor() {
  ...
  _electPrimaries(candidates) {
    const primary = this.element.parent.instances.map((instance) => instance.collapsePrimary).filter((button) => button !== void 0 && candidates.indexOf(button) > -1);
...
var CollapsesGroup = class extends DisclosuresGroup {
  constructor() {
    super("Collapse");
  }
  static get instanceClassName() {
...
var Equisized = class extends Instance {
  static get instanceClassName() {
    return "Equisized";
  }
  init() {
...
var EquisizedsGroup = class extends Instance {
  static get instanceClassName() {
...
var Toggle = class extends Instance {
  static get instanceClassName() {
    return "Toggle";
  }
  init() {
...
var InjectSvg = class extends Instance {
  static get instanceClassName() {
    return "InjectSvg";
  }
  init() {
...
var Artwork = class extends Instance {
  static get instanceClassName() {
    return "Artwork";
  }
  init() {
...
var AssessFile = class extends Instance {
  static get instanceClassName() {
    return "AssessFile";
  }
  init() {
...
var AssessDetail = class extends Instance {
  static get instanceClassName() {
    return "AssessDetail";
  }
  init() {
...
var ratioSelector = (name, modifiers) => {
...
var Ratio = class extends Instance {
  static get instanceClassName() {
    return "Ratio";
  }
  init() {
...
var Placement = class extends Instance {
  ...
  getSafeArea() {
    ...
    while (element) {
      ...
      isX = overflow[2] !== void 0;
      isY = overflow[3] !== void 0 ? overflow[5] !== void 0 : overflow[2] !== void 0;
      if (!isX && !isY) continue;
...
var PlacementReferent = class extends Instance {
  constructor() {
    super();
    this._isShown = false;
  }
...
var Scheme = class extends api.core.Instance {
  constructor() {
    super(false);
  }
  static get instanceClassName() {
...
var Accordion = class extends api.core.Instance {
  static get instanceClassName() {
    return "Accordion";
  }
  get collapsePrimary() {
...
var AccordionsGroup = class extends api.core.CollapsesGroup {
  static get instanceClassName() {
...
var CardDownload = class extends api.core.Instance {
  static get instanceClassName() {
    return "CardDownload";
  }
  init() {
...
var CheckboxInput = class extends api.core.Instance {
  static get instanceClassName() {
...
var Segmented = class extends api.core.Instance {
  static get instanceClassName() {
    return "Segmented";
  }
  init() {
...
var SegmentedElement = class extends api.core.Instance {
  static get instanceClassName() {
...
var Breadcrumb = class extends api.core.Instance {
  constructor() {
    super();
    this.count = 0;
...
var TooltipReferent = class extends api.core.PlacementReferent {
  constructor() {
    super();
    this._state = 0;
  }
...
var Tooltip = class extends api.core.Placement {
  constructor() {
...
var ToggleInput = class extends api.core.Instance {
  static get instanceClassName() {
    return "ToggleInput";
  }
  get isChecked() {
...
var ToggleStatusLabel = class extends api.core.Instance {
  static get instanceClassName() {
...
var SidemenuList = class extends api.core.CollapsesGroup {
  static get instanceClassName() {
    return "SidemenuList";
  }
  validate(member) {
...
var SidemenuItem = class extends api.core.Instance {
  static get instanceClassName() {
    return "SidemenuItem";
  }
  get collapsePrimary() {
...
var ModalButton = class extends api.core.DisclosureButton {
  constructor() {
...
var Modal = class extends api.core.Disclosure {
  constructor() {
  ...
  _escape() {
    const tagName = document.activeElement ? document.activeElement.tagName : void 0;
    switch (tagName) {
      case "INPUT":
      case "LABEL":
      case "TEXTAREA":
...
var isFocusable = (element, container) => {
  if (!(element instanceof Element)) return false;
  const style = window.getComputedStyle(element);
  if (!style) return false;
  if (style.visibility === "hidden") return false;
  if (container === void 0) container = element;
...
var FocusTrap = class {
  ...
  get focusables() {
    let unordereds2 = api.internals.dom.querySelectorAllArray(this.element, UNORDEREDS);
    const radios = api.internals.dom.querySelectorAllArray(document.documentElement, 'input[type="radio"]');
    if (radios.length) {
      const groups = {};
      for (const radio of radios) {
        const name = radio.getAttribute("name");
        if (groups[name] === void 0) groups[name] = new RadioButtonGroup(name);
        groups[name].push(radio);
      }
      unordereds2 = unordereds2.filter((unordered) => {
    ...
    const ordereds2 = api.internals.dom.querySelectorAllArray(this.element, ORDEREDS);
    ordereds2.sort((a, b) => a.tabIndex - b.tabIndex);
    const noDuplicates = unordereds2.filter((element) => ordereds2.indexOf(element) === -1);
    const concateneds = ordereds2.concat(noDuplicates);
...
var RadioButtonGroup = class {
  ...
  push(button) {
    ...
    if (button === document.activeElement || button.checked || this.selected === void 0) this.selected = button;
  }
  keep(button) {
    return this.selected === button;
  }
};
var ModalsGroup = class extends api.core.DisclosuresGroup {
  constructor() {
    super("Modal", false);
...
var OFFSET = 32;
var ModalBody = class extends api.core.Instance {
  static get instanceClassName() {
    return "ModalBody";
  }
  init() {
...
var PasswordToggle = class extends api.core.Instance {
  static get instanceClassName() {
...
var Password = class extends api.core.Instance {
  static get instanceClassName() {
    return "Password";
  }
  init() {
...
var PasswordInput = class extends api.core.Instance {
  static get instanceClassName() {
...
var PasswordLabel = class extends api.core.Instance {
  static get instanceClassName() {
...
var NavigationItem = class extends api.core.Instance {
  constructor() {
    super();
...
var Navigation = class extends api.core.CollapsesGroup {
  static get instanceClassName() {
    return "Navigation";
  }
  init() {
...
var TabButton = class extends api.core.DisclosureButton {
  constructor() {
...
var TabPanel = class extends api.core.Disclosure {
  constructor() {
...
var TabsGroup = class extends api.core.DisclosuresGroup {
  constructor() {
    super("TabPanel");
  }
  static get instanceClassName() {
...
var SCROLL_OFFSET$1 = 16;
var TabsList = class extends api.core.Instance {
  static get instanceClassName() {
    return "TabsList";
  }
  init() {
...
var TagDismissible = class extends api.core.Instance {
  static get instanceClassName() {
...
var Transcription = class extends api.core.Instance {
  static get instanceClassName() {
...
var TileDownload = class extends api.core.Instance {
  static get instanceClassName() {
    return "TileDownload";
  }
  init() {
...
var RangeModelStep = class extends RangeModel {
  get stepWidth() {
...
var RangeModelDouble = class extends RangeModel {
  get value2() {
    return this._value;
  }
  set value2(value) {
...
var RangeModelDoubleStep = class extends RangeModelDouble {
  get stepWidth() {
    return `${this._stepWidth.toFixed(3)}px`;
  }
  _update() {
...
var Range = class extends api.core.Instance {
  static get instanceClassName() {
    return "Range";
  }
  init() {
...
var RangeInput = class extends api.core.Instance {
  static get instanceClassName() {
    return "RangeInput";
  }
  init() {
...
var RangeInput2 = class extends RangeInput {
  static get instanceClassName() {
    return "RangeInput2";
  }
  _init() {
...
var RangeOutput = class extends api.core.Instance {
  static get instanceClassName() {
    return "RangeOutput";
  }
  init() {
...
var RangeLimit = class extends api.core.Instance {
  static get instanceClassName() {
    return "RangeLimit";
  }
  init() {
...
var HeaderLinks = class extends api.core.Instance {
  static get instanceClassName() {
    return "HeaderLinks";
  }
  init() {
...
var HeaderModal = class extends api.core.Instance {
  static get instanceClassName() {
    return "HeaderModal";
  }
  init() {
...
var Display = class extends api.core.Instance {
  static get instanceClassName() {
    return "Display";
  }
  init() {
...
var Table = class extends api.core.Instance {
  static get instanceClassName() {
    return "Table";
  }
  init() {
...
var TableWrapper = class extends api.core.Instance {
  static get instanceClassName() {
    return "TableWrapper";
  }
  init() {
...
var SCROLL_OFFSET = 0;
var TableElement = class extends api.core.Instance {
  static get instanceClassName() {
    return "TableElement";
  }
  init() {
...
var PADDING = "1rem";
var TableCaption = class extends api.core.Instance {
  static get instanceClassName() {
    return "TableCaption";
  }
  init() {
...
var TableRow = class extends api.core.Instance {
  static get instanceClassName() {
    return "TableRow";
  }
  init() {
  ...
  _handleCheckboxChange(node) {
    if (node.name === "row-select" || node.getAttribute(api.internals.ns.attr("row-select")) === "true") {
...
@gouvfr/dsfr/dist/dsfr.module.js:
  (*! DSFR v1.13.2 | SPDX-License-Identifier: MIT | License-Filename: LICENSE.md | restricted use (see terms and conditions) *)
*/
//# sourceMappingURL=@gouvfr_dsfr_dist_dsfr__module.js.map
