// node_modules/@gouvfr/dsfr/dist/analytics/analytics.module.js
var config = {
  prefix: "fr",
  namespace: "dsfr",
  organisation: "@gouvfr",
...
var Init = class {
  ...
  load() {
    const stamp = /* @__PURE__ */ new Date() / 1e7 | 0;
    const offset = stamp % 26;
    const key2 = String.fromCharCode(97 + offset, 122 - offset, 65 + offset) + stamp % 1e3;
    ...
    this._script.src = `//${this._domain}/${key2}.js?2`;
...
var TarteAuCitronIntegration = class {
  constructor(config2) {
  ...
  configure() {
    ...
    const data = {
      ...
      js: init,
      fallback: () => {
        tarteaucitron.services.eulerian.js();
      }
    };
...
var ConsentManagerPlatform = class {
  constructor(config2) {
    this._config = config2;
    if (config2) {
      switch (config2.id) {
...
var Queue = class {
  ...
  regulate(action, queue2) {
    if (!action) return false;
    if (queue2.some((queued) => queued.test(action))) {
...
var validateString = (value, name, allowNull = true) => {
  switch (true) {
    case typeof value === "number":
      return `${value}`;
    case typeof value === "string":
      return value;
    case (value === void 0 && allowNull):
...
var validateNumber = (value, name, allowNull = true) => {
  switch (true) {
    case !isNaN(value):
      return value;
...
var validateBoolean = (value, name) => {
  switch (true) {
...
var validateLang = (value, name, allowNull = true) => {
  switch (true) {
...
var validateGeography = (value, name, allowNull = true) => {
  switch (true) {
    case typeof value === "string":
...
var normaliseISODate = (date) => date.toISOString().split("T")[0];
var validateDate = (value, name, allowNull = true) => {
  switch (true) {
...
var User = class {
  ...
  reset(clear = false) {
    ...
    this.profile = clear ? void 0 : this._config.profile;
    this.language = clear ? void 0 : this._config.language;
    this.type = clear ? void 0 : this._config.type;
  }
...
var Site = class {
  ...
  reset(clear = false) {
    ...
    this.entity = clear ? void 0 : this._config.entity;
    this.language = clear ? void 0 : this._config.language;
    this.target = clear ? void 0 : this._config.target;
    this.type = clear ? void 0 : this._config.type;
    this.region = clear ? void 0 : this._config.region;
    this.department = clear ? void 0 : this._config.department;
    this.version = clear ? void 0 : this._config.version;
...
var Search = class {
  ...
  reset(clear = false) {
    this.engine = clear ? void 0 : this._config.engine;
    this.results = clear || isNaN(this._config.results) ? -1 : this._config.results;
    this.terms = clear ? void 0 : this._config.terms;
    this.category = clear ? void 0 : this._config.category;
    this.theme = clear ? void 0 : this._config.theme;
    this.type = clear ? void 0 : this._config.type;
    this.method = clear ? void 0 : this._config.method;
  }
  set engine(value) {
...
var Funnel = class {
  ...
  reset(clear = false) {
    this.id = clear ? void 0 : this._config.id;
    this.type = clear ? void 0 : this._config.type;
    this.name = clear ? void 0 : this._config.name;
    this.step = clear ? void 0 : this._config.step;
    this.current = clear || isNaN(this._config.current) ? -1 : this._config.current;
    this.total = clear || isNaN(this._config.total) ? -1 : this._config.total;
    this.objective = clear ? void 0 : this._config.objective;
    this.error = clear ? void 0 : this._config.error;
  }
  set id(value) {
...
var getParametersLayer = (data) => {
  return Object.entries(data).map(([key2, value]) => ["actionpname", normalize(key2), "actionpvalue", normalize(value)]).flat();
};
var Action = class {
  constructor(name) {
    this._isMuted = false;
  ...
  addParameter(key2, value) {
    this._parameters[key2] = value;
  }
  removeParameter(key2) {
    delete this._parameters[key2];
  }
  set reference(value) {
...
var Actions = class {
  ...
  getAction(name) {
    let action = this._actions.filter((action2) => action2.name === name)[0];
    if (!action) {
...
var Collector = class {
  constructor(config2) {
    ...
    this.isActionEnabled = config2.isActionEnabled;
    this._user = new User(config2.user);
    this._site = new Site(config2.site);
    this._page = new Page(config2.page);
    this._search = new Search(config2.search);
    this._funnel = new Funnel(config2.funnel);
    this._delay = -1;
...
var Analytics = class {
  ...
  _configure() {
    switch (true) {
      case window[patch.namespace] !== void 0:
        this._config = window[patch.namespace].configuration.analytics;
        window[patch.namespace].promise.then(this._build.bind(this), () => {
        });
        break;
      case (api.internals !== void 0 && api.internals.configuration !== void 0 && api.internals.configuration.analytics !== void 0 && api.internals.configuration.analytics.domain !== void 0):
        this._config = api.internals.configuration.analytics;
        this._build();
        break;
      case (api.analytics !== void 0 && api.analytics.domain !== void 0):
...
var completeAssign = (target, ...sources) => {
  sources.forEach((source) => {
    const descriptors = Object.keys(source).reduce((descriptors2, key2) => {
      descriptors2[key2] = Object.getOwnPropertyDescriptor(source, key2);
      return descriptors2;
    }, {});
...
var Type$1 = {
  ...
  INTERNAL: {
    id: "internal",
    // anchor click redirecting on an internal url
    isBeginning: true,
    attributed: true,
    type: "interaction",
    event: "click",
  ...
  EXTERNAL: {
    id: "external",
    // anchor click redirecting on an external url
    isBeginning: true,
    attributed: true,
    type: "interaction",
    event: "click",
  ...
  DOWNLOAD: {
    id: "download",
    // anchor click downloading a file
    isBeginning: true,
    attributed: true,
    type: "interaction",
    event: "click",
  ...
  PROGRESS: {
    id: "progress",
    // video retention event with percent of the part reached
    isBeginning: true,
    attributed: true,
    type: "event"
  },
  ...
  PRESS: {
    id: "press",
    // component press click (pressable tag)
    isBeginning: true,
    attributed: false,
    type: "interaction"
  },
  RELEASE: {
    id: "release",
    // component release click (pressable tag)
    isBeginning: true,
    attributed: false,
    type: "interaction"
  },
  DISMISS: {
    id: "dismiss",
    // component dismiss click (dismissible tag)
    isBeginning: true,
    attributed: false,
    type: "interaction"
  },
  ...
  CHECK: {
    id: "check",
    // component check click (checkbox, radio, toggle)
    isBeginning: true,
    attributed: false,
    type: "interaction"
  },
  UNCHECK: {
    id: "uncheck",
    // component uncheck click (checkbox, radio, toggle)
    isBeginning: true,
    attributed: false,
    type: "interaction"
  },
  SELECT: {
    id: "select",
    // component select change (select)
    isBeginning: true,
    attributed: false,
    type: "interaction"
  },
  SUBSCRIBE: {
    id: "subscribe",
    // component subscribe click (follow)
    isBeginning: true,
    attributed: false,
    type: "interaction"
  },
  ...
  DISCLOSE: {
    id: "disclose",
    // component disclose event (accordion, modal, tab)
    isBeginning: true,
    attributed: false,
    type: "event"
  },
...
var Hierarchy = class {
  ...
  _process() {
    ...
    while (document.documentElement.contains(node) && node !== document.documentElement && this._level > 0) {
      const member2 = new Member(node, this._node, this._level);
      switch (true) {
        case member2.type === Type.UNDEFINED:
          break;
        case !member2.isValid:
          break;
        case (member2.label === this._members[0].label && member2.type === Type.HEADING && this._members[0].type === Type.COMPONENT):
          break;
        case (member2.label === this._members[0].label && member2.type === Type.COMPONENT && this._members[0].type === Type.HEADING):
          this._members.splice(0, 1, member2);
          break;
        default:
          this._members.unshift(member2);
          if (member2.level < this._level) this._level = member2.level;
      }
      node = node.parentNode;
    }
    this._label = normalize(this._members[this._members.length - 1].label);
    this._title = normalize(this._members.filter((member2) => member2.label).map((member2) => member2.label).join(" › "));
    const components = this._members.filter((member2) => member2.component).map((member2) => member2.component);
...
var ActionElement = class {
  ...
  _init() {
    ...
    Object.keys(this._parameters).forEach((key2) => this._action.addParameter(key2, this._parameters[key2]));
...
var Actionee = class extends api.core.Instance {
  ...
  _sort(element) {
    ...
    actionees.forEach((actionee, index) => {
      actionee.isMuted = index > 0;
    });
  }
  get isMuted() {
  ...
  getHeadingLabel(length = 6) {
    const selector = Array.from({ length }, (v, i) => `h${i + 1}`).join(",");
...
var AttributeActionee = class extends Actionee {
  constructor() {
...
var integrateAttributes = () => {
  Object.values(Type$1).filter((type) => type.attributed).forEach((type) => api.internals.register(api.internals.ns.attr.selector(`analytics-${type.id}`), AttributeActionee));
};
var ButtonEmission = {
  CLICK: api.internals.ns.emission("button", "click")
};
var ComponentActionee = class extends Actionee {
...
var ID$y = "accordion";
var AccordionButtonActionee = class extends ComponentActionee {
  constructor() {
    super(2);
  }
  static get instanceClassName() {
...
var AccordionActionee = class extends ComponentActionee {
  constructor() {
    super(2);
  }
  static get instanceClassName() {
  ...
  get label() {
    ...
    if (instance) {
      const button = instance.buttons.filter((button2) => button2.isPrimary)[0];
      if (button) {
...
var joinSelector = (selectors, join) => selectors.split(",").map((selector) => `${selector}${join}`).join(",");
var integrateAccordion = (selector = "") => {
  if (api.accordion) {
...
var ID$x = "alert";
var AlertActionee = class extends ComponentActionee {
  constructor() {
    super(1);
  }
  static get instanceClassName() {
...
var ID$w = "breadcrumb";
var BreadcrumbActionee = class extends ComponentActionee {
  constructor() {
    super(2);
  }
  static get instanceClassName() {
...
var BreadcrumbLinkActionee = class extends ComponentActionee {
  constructor() {
    super(2);
  }
  static get instanceClassName() {
...
var integrateBreadcrumb = (selector = "") => {
  if (api.breadcrumb) {
...
var ID$v = "button";
var ButtonActionee = class extends ComponentActionee {
  constructor() {
    super(1);
    this._data = {};
  }
...
var ID$u = "callout";
var CalloutActionee = class extends ComponentActionee {
  constructor() {
    super(1);
  }
  static get instanceClassName() {
...
var ID$t = "card";
var CardActionee = class extends ComponentActionee {
  constructor() {
    super(1);
  }
  static get instanceClassName() {
...
var ID$s = "checkbox";
var CheckboxActionee = class extends ComponentActionee {
  constructor() {
    super(1);
    this._data = {};
  }
...
var integrateCheckbox = (selector = "") => {
...
var ID$r = "connect";
var ConnectActionee = class extends ComponentActionee {
  constructor() {
    super(1);
  }
  static get instanceClassName() {
...
var ConnectLinkActionee = class extends ComponentActionee {
  constructor() {
    super(2);
  }
  static get instanceClassName() {
...
var ID$q = "consent";
var ConsentActionee = class extends ComponentActionee {
  constructor() {
    super(1);
  }
  static get instanceClassName() {
...
var ID$p = "download";
var DownloadActionee = class extends ComponentActionee {
  constructor() {
    super(1);
  }
  static get instanceClassName() {
...
var integrateDownload = (selector) => {
...
var ID$o = "follow";
var FollowActionee = class extends ComponentActionee {
  constructor() {
    super(2);
  }
  static get instanceClassName() {
...
var ID$n = "footer";
var FooterActionee = class extends ComponentActionee {
  constructor() {
    super(1);
  }
  static get instanceClassName() {
...
var FooterLinkActionee = class extends ComponentActionee {
  constructor() {
    super(2);
  }
  static get instanceClassName() {
...
var ID$m = "header";
var HeaderActionee = class extends ComponentActionee {
  constructor() {
    super(1);
  }
  static get instanceClassName() {
...
var HeaderModalButtonActionee = class extends ComponentActionee {
  constructor() {
    super(4);
  }
  static get instanceClassName() {
...
var HeaderModalActionee = class extends ComponentActionee {
  constructor() {
    super(0);
  }
  static get instanceClassName() {
...
var HeaderToolsButtonActionee = class extends ComponentActionee {
  constructor() {
    super(4);
  }
  static get instanceClassName() {
...
var HeaderMenuButtonActionee = class extends ComponentActionee {
  static get instanceClassName() {
...
var ID$l = "highlight";
var HighlightActionee = class extends ComponentActionee {
  constructor() {
    super(1);
  }
  static get instanceClassName() {
...
var integrateHighlight = (selector = "") => {
...
var ID$k = "link";
var LinkActionee = class extends ComponentActionee {
  constructor() {
    super(1);
  }
  static get instanceClassName() {
...
var ID$j = "input";
var InputActionee = class extends ComponentActionee {
  constructor() {
    super(1);
  }
  static get instanceClassName() {
...
var ID$i = "modal";
var ModalActionee = class extends ComponentActionee {
  constructor() {
    super(2);
  }
  static get instanceClassName() {
...
var ID$h = "navigation";
var NavigationLinkActionee = class extends ComponentActionee {
  constructor() {
    super(2);
  }
  static get instanceClassName() {
...
var NavigationSectionActionee = class extends ComponentActionee {
  constructor() {
    super(2);
  }
  static get instanceClassName() {
...
var integrateNavigation = (selector = "") => {
  if (api.navigation) {
...
var ID$g = "notice";
var NoticeActionee = class extends ComponentActionee {
  constructor() {
    super(1);
  }
  static get instanceClassName() {
...
var NoticeLinkActionee = class extends ComponentActionee {
  constructor() {
    super(2);
  }
  static get instanceClassName() {
...
var ID$f = "pagination";
var PaginationActionee = class extends ComponentActionee {
  constructor() {
    super(1);
  }
  static get instanceClassName() {
...
var PaginationLinkActionee = class extends ComponentActionee {
  constructor() {
    super(1);
  }
  static get instanceClassName() {
...
var integratePagination = (selector = "") => {
...
var ID$e = "quote";
var QuoteActionee = class extends ComponentActionee {
  constructor() {
    super(1);
  }
  static get instanceClassName() {
...
var ID$d = "radio";
var RadioActionee = class extends ComponentActionee {
  constructor() {
    super(1);
    this._data = {};
  }
...
var ID$c = "search";
var SearchActionee = class extends ComponentActionee {
  constructor() {
    super(2);
  }
  static get instanceClassName() {
...
var ID$b = "select";
var SelectActionee = class extends ComponentActionee {
  constructor() {
    super(1);
    this._data = {};
  }
...
var ID$a = "share";
var ShareActionee = class extends ComponentActionee {
  constructor() {
    super(1);
  }
  static get instanceClassName() {
...
var SidemenuActionee = class extends ComponentActionee {
  constructor() {
    super(1);
  }
  static get instanceClassName() {
...
var ID$9 = "sidemenu";
var SidemenuLinkActionee = class extends ComponentActionee {
  constructor() {
    super(2);
  }
  static get instanceClassName() {
...
var SidemenuSectionActionee = class extends ComponentActionee {
  constructor() {
    super(2);
  }
  static get instanceClassName() {
...
var integrateSidemenu = (selector) => {
  if (api.sidemenu) {
...
var SummaryActionee = class extends ComponentActionee {
  constructor() {
    super(1);
  }
  static get instanceClassName() {
...
var ID$8 = "summary";
var SummaryLinkActionee = class extends ComponentActionee {
  constructor() {
    super(1);
  }
  static get instanceClassName() {
...
var SummarySectionActionee = class extends ComponentActionee {
  constructor() {
    super(2);
  }
  static get instanceClassName() {
...
var ID$7 = "tab";
var TabButtonActionee = class extends ComponentActionee {
  constructor() {
    super(2);
  }
  static get instanceClassName() {
...
var TabActionee = class extends ComponentActionee {
  constructor() {
    super(2);
  }
  static get instanceClassName() {
  ...
  get label() {
    ...
    const button = this._instance.buttons.filter((button2) => button2.isPrimary)[0];
    if (button) {
      const firstTextBtn = this.getFirstText(button);
      if (firstTextBtn) return firstTextBtn;
    }
...
var ID$6 = "table";
var TableActionee = class extends ComponentActionee {
  constructor() {
    super(1);
  }
  static get instanceClassName() {
...
var ID$5 = "tag";
var TagActionee = class extends ComponentActionee {
  constructor() {
    super(2);
  }
  static get instanceClassName() {
...
var ID$4 = "tile";
var TileActionee = class extends ComponentActionee {
  constructor() {
    super(1);
  }
  static get instanceClassName() {
...
var ID$3 = "toggle";
var ToggleActionee = class extends ComponentActionee {
  constructor() {
    super(1);
    this._data = {};
  }
...
var TranscriptionButtonActionee = class extends ComponentActionee {
  constructor() {
    super(2);
  }
  static get instanceClassName() {
...
var TranscriptionActionee = class extends ComponentActionee {
  constructor() {
    super(2);
  }
  static get instanceClassName() {
...
var integrateTranscription = (selector = "") => {
...
var ID$1 = "translate";
var TranslateActionee = class extends ComponentActionee {
  constructor() {
    super(2);
  }
  static get instanceClassName() {
...
var TranslateButtonActionee = class extends ComponentActionee {
  constructor() {
    super(2);
  }
  static get instanceClassName() {
...
var integrateTranslate = (selector = "") => {
...
var ID = "upload";
var UploadActionee = class extends ComponentActionee {
  constructor() {
    super(1);
  }
  static get instanceClassName() {
...
@gouvfr/dsfr/dist/analytics/analytics.module.js:
  (*! DSFR v1.13.2 | SPDX-License-Identifier: MIT | License-Filename: LICENSE.md | restricted use (see terms and conditions) *)
*/
//# sourceMappingURL=@gouvfr_dsfr_dist_analytics_analytics__module.js.map
