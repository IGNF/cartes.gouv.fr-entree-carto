...
const getDataServiceWMS = (data) => {
  ...
  //   "format":"WMS",
  //   "title":"Académies",
  //   "description":"L'académie est la circonscription administrative de l'éducation nationale. La France est partagée en 30 académies dont 26 académies hexagonales et quatre académies d'outre-mer : Guadeloupe, Guyane, Martinique et La Réunion . Chaque académie correspond à une région, sauf en Île-de-France, Rhône-Alpes et Provence-Alpes-Côte d'Azur. Les autres collectivités d'outre-mer disposent d'un vice-rectorat ou de services de l'éducation nationale. Sources : IGN BD Topo 2015, MENESR avril 2015",
