...
cf. https://github.com/IGNF/cartes.gouv.fr-entree-carto/pull/894/

routes : `/login` et `/logout`

La logique de session / authentification est sur le composant : `src/components/header/CustomNavigation.vue`
