...
export default {
  ...
  bookmark: {
    ...
    warning_delete_permalink_in_bookmarks_carte: "Attention : en cas de suppression, si vous avez partagé ce permalien, il ne sera plus disponible pour les utilisateurs.",
