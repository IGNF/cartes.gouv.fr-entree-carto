...
declare module 'vue' {
  export interface GlobalComponents {
    ...
    MenuBookMarkLogguedIn: typeof import('./components/menu/bookmarks/MenuBookMarkLogguedIn.vue')['default']
    MenuBookMarkLogguedOut: typeof import('./components/menu/bookmarks/MenuBookMarkLogguedOut.vue')['default']
